...
val appBuildTrain = "1B"
val appBuildSequenceOffset = 78
val androidVersionBase = 272
...
abstract class ReserveBuildNumber : DefaultTask() {
    ...
    fun reserve() {
        ...
        logger.lifecycle(
            "Fuyao Photos ${marketingVersion.get()} (${buildTrain.get()}$sequence), " +
...
android {
    ...
    defaultConfig {
        ...
        manifestPlaceholders["appLabel"] = "Fuyao Photos"
    ...
    buildTypes {
        debug {
            ...
            manifestPlaceholders["appLabel"] = "Fuyao Photos Debug"
        }
        create("debugUnsigned") {
            ...
            signingConfig = null
            manifestPlaceholders["appLabel"] = "Fuyao Photos Debug Unsigned"
        ...
        create("releaseUnsigned") {
            ...
            signingConfig = null
            manifestPlaceholders["appLabel"] = "Fuyao Photos Release Unsigned"
            matchingFallbacks += "release"
        }
    }
    buildFeatures { compose = true; buildConfig = true }
    // Keep only the locales the app actually ships; must match res/xml/locales_config.xml.
    androidResources {
