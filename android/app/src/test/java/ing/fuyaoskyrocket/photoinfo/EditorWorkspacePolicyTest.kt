...
class EditorWorkspacePolicyTest {
    @Test fun unhingedWindowsKeepTheEditorBelowThePhoto() {
        ...
        assertFalse(EditorWorkspacePolicy.calculate(760f, 340f, 1f, false).sideBySide)
    }
